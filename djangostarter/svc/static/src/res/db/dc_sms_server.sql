...
INSERT INTO `django_content_type` VALUES (1,'permission','auth','permission'),(2,'group','auth','group'),(3,'user','auth','user'),(4,'content type','contenttypes','contenttype'),(5,'session','sessions','session'),(6,'site','sites','site'),(7,'auth group','svc','authgroup'),(8,'auth group permissions','svc','authgrouppermissions'),(9,'auth permission','svc','authpermission'),(10,'auth user','svc','authuser'),(11,'auth user groups','svc','authusergroups'),(12,'auth user user permissions','svc','authuseruserpermissions'),(13,'django admin log','svc','djangoadminlog'),(14,'django content type','svc','djangocontenttype'),(15,'django migrations','svc','djangomigrations'),(16,'django session','svc','djangosession'),(17,'django site','svc','djangosite'),(18,'log entry','admin','logentry');
